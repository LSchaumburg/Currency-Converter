...
def get_details(country_name):
    countries_file = open('currency_details.txt', encoding='utf-8')
...
def get_all_details():
    ...
    for line in countries_file:
        ...
        all_details[country_line[0]] = (country_line[0], country_line[1], country_line[2].strip("\n"))
    return all_details
